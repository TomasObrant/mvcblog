					...
					<div class="row">
						<div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
							...
							<ul class="list-unstyled breadCrumbs d-flex justify-content-center">
								<li class="mr-sm-2 mr-1"><a href="index.php">Home</a></li>
								<li class="mr-sm-2 mr-1">/</li>
								<li class="mr-sm-2 mr-1"><a href="shop.php">Shop</a></li>
								<li class="mr-sm-2 mr-1">/</li>
							...
							<tbody>
								<tr class="align-items-center">
									<td class="d-flex align-items-center border-top-0 border-bottom px-0 py-6">
										<div class="imgHolder">
											<img src="https://via.placeholder.com/70x80" alt="image description" class="img-fluid">
										</div>
										<span class="title pl-2"><a href="product.php">Pellentesque aliquet</a></span>
									</td>
								...
								<tr class="align-items-center">
									<td class="d-flex align-items-center border-top-0 border-bottom px-0 py-6">
										...
										<span class="title pl-2"><a href="product.php">Neque Porro Quisquam</a></span>
									</td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $</td>
									<td class="border-top-0 border-bottom px-0 py-6"><input type="number" placeholder="1"></td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $ <a href="javascript:void(0);" class="fas fa-times float-right"></a></td>
								...
								<tr class="align-items-center">
									<td class="d-flex align-items-center border-top-0 border-bottom px-0 py-6">
										...
										<span class="title pl-2"><a href="product.php">Aliquam Quaerat Voluptem</a></span>
									</td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $</td>
									<td class="border-top-0 border-bottom px-0 py-6"><input type="number" placeholder="1"></td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $ <a href="javascript:void(0);" class="fas fa-times float-right"></a></td>
								...
								<tr class="align-items-center">
									<td class="d-flex align-items-center border-top-0 border-bottom px-0 py-6">
										...
										<span class="title pl-2"><a href="product.php">Sint Incidunt Utlabore</a></span>
									</td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $</td>
									<td class="border-top-0 border-bottom px-0 py-6"><input type="number" placeholder="1"></td>
									<td class="fwEbold border-top-0 border-bottom px-0 py-6">180.00 $ <a href="javascript:void(0);" class="fas fa-times float-right"></a></td>
