								...
								<div class="col-12 col-sm-6 col-lg-4 featureCol mb-7">
									<div class="border">
										<div class="imgHolder position-relative w-100 overflow-hidden">
											<img src="https://via.placeholder.com/270x300" alt="image description" class="img-fluid w-100">
							...
							<section class="widget mb-9">
								...
								<ul class="list-unstyled recentListHolder mb-0 overflow-hidden">
									<li class="mb-6 d-flex flex-nowrap">
										<div class="alignleft">
											<a href="product.php"><img src="https://via.placeholder.com/70x80" alt="image description" class="img-fluid"></a>
										</div>
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="product.php">Vitamin C face wash</a></h4>
									...
									<li class="mb-6 d-flex flex-nowrap">
										...
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="product.php">Organic vegetables</a></h4>
											<strong class="price fwEbold d-block;">21.00 $</strong>
										</div>
									</li>
									<li class="mb-6 d-flex flex-nowrap">
										...
										<div class="description-wrap pl-1">
											<h4 class="headingVII mb-1"><a href="product.php">Organic cabbage</a></h4>
											<strong class="price fwEbold d-block;">21.00 $</strong>
										</div>
									</li>
									<li class="mb-6 d-flex flex-nowrap">
