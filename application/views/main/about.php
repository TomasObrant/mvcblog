		...
		<main>
			...
			<section class="abtSecHolder container pt-xl-24 pb-xl-12 pt-lg-20 pb-lg-10 pt-md-16 pb-md-8 pt-10 pb-5">
				<div class="row">
					...
					<div class="col-12 col-lg-6">
						<img src="https://via.placeholder.com/570x440" alt="image description" class="img-fluid">
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-6 mb-lg-0 mb-6">
							<img src="https://via.placeholder.com/490x505" alt="image description" class="img-fluid">
						</div>
						<div class="col-12 col-lg-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 mb-lg-0 mb-6">
							<article class="teamBlock overflow-hidden">
								<span class="imgWrap position-relative d-block w-100 mb-4">
									<img src="https://via.placeholder.com/370x290" class="img-fluid" alt="image description">
			...
			<div class="container-fluid px-xl-20 mb-xl-24 mb-lg-20 mb-md-16 mb-10">
				<!-- subscribeSecBlock -->
				<section class="subscribeSecBlock bgCover pt-xl-24 pb-xl-12 pt-lg-20 pb-lg-10 pt-md-16 pb-md-10 py-10 px-3" style="background-image: url(https://via.placeholder.com/1720x465)">
					<header class="col-12 mainHeader mb-9 text-center">
