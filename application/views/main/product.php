					...
					<div class="row">
						<div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
							...
							<ul class="list-unstyled breadCrumbs d-flex justify-content-center">
								...
								<li class="mr-2">/</li>
								<li class="mr-2"><a href="shop.php">Shop</a></li>
								<li class="mr-2">/</li>
				...
				<div class="row mb-6">
					<div class="col-12 col-lg-6 order-lg-1">
						...
						<div class="productSliderImage mb-lg-0 mb-4">
							<div>
								<img src="https://via.placeholder.com/570x635" alt="image description" class="img-fluid w-100">
							</div>
							<div>
								<img src="https://via.placeholder.com/570x635" alt="image description" class="img-fluid w-100">
							</div>
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="paggSlider">
							<div>
								<div class="imgBlock">
									<img src="https://via.placeholder.com/170x190" alt="image description" class="img-fluid">
								</div>
							</div>
							<div>
								<div class="imgBlock">
