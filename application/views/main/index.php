		...
		<main>
			...
			<section class="introBlock position-relative">
				<div class="slick-fade">
					<div>
						<div class="align w-100 d-flex align-items-center bgCover" style="background-image: url(../../../public/images/b-bg.jpg);">
							<!-- holder -->
							<div class="container position-relative holder pt-xl-10 pt-0">
								...
								<div class="row">
									...
									<div class="imgHolder">
										<img src="https://via.placeholder.com/900x795" alt="image description" class="img-fluid w-100">
									</div>
								</div>
							</div>
						</div>
					...
					<div>
						<div class="align w-100 d-flex align-items-center bgCover" style="background-image: url(../../../public/images/b-bg2.jpg);">
							<!-- holder -->
							<div class="container position-relative holder pt-xl-10 pt-0">
								<!-- py-12 pt-lg-30 pb-lg-25 -->
								<div class="row">
									...
									<div class="imgHolder">
										<img src="https://via.placeholder.com/800x700" alt="image description" class="img-fluid w-100">
									</div>
								</div>
							</div>
						</div>
					...
					<div>
						<div class="align w-100 d-flex align-items-center bgCover" style="background-image: url(../../../public/images/b-bg3.jpg);">
							<!-- holder -->
							<div class="container position-relative holder pt-xl-10 pt-0">
								<!-- py-12 pt-lg-30 pb-lg-25 -->
								<div class="row">
									...
									<div class="imgHolder">
										<img src="https://via.placeholder.com/820x815" alt="image description" class="img-fluid w-100">
									</div>
								</div>
							</div>
						</div>
			...
			<section class="chooseUs-sec container pt-xl-22 pt-lg-20 pt-md-16 pt-10 pb-xl-12 pb-md-7 pb-2">
				<div class="row">
					<div class="col-12 col-lg-6 mb-lg-0 mb-4">
						<img src="https://via.placeholder.com/570x590" alt="image description" class="img-fluid">
					</div>
			...
			<section class="featureSec container-fluid overflow-hidden pt-xl-12 pt-lg-10 pt-md-80 pt-5 pb-xl-10 pb-lg-4 pb-md-2 px-xl-14 px-lg-7">
				...
				<header class="col-12 mainHeader mb-7 text-center">
					...
					<span class="headerBorder d-block mb-md-5 mb-3"><img src="../../../public/images/hbdr.png" alt="Header Border" class="img-fluid img-bdr"></span>
				...
				<div class="col-12 p-0 overflow-hidden d-flex flex-wrap">
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							<div class="imgHolder position-relative w-100 overflow-hidden">
								<img src="https://via.placeholder.com/320x355" alt="image description" class="img-fluid w-100">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Sit voluptatem</a></span>
					...
					<div class="featureCol px-3 position-relative mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Neque Porro Quisquamest</a></span>
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Pellentesque aliquet</a></span>
								<span class="price d-block fwEbold">68.00 $</span>
							</div>
						</div>
					</div>
					...
					<div class="featureCol px-3 position-relative mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Aspetur Autodit Autfugit</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Sint Incidunt Utlabore</a></span>
					...
					<div class="featureCol px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Aliquam Quaerat Voluptem</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Neque Porro Quisquam</a></span>
					...
					<div class="featureCol position-relative px-3 mb-6">
						<div class="border">
							...
							<div class="text-center py-xl-5 py-sm-4 py-2 px-xl-2 px-1">
								<span class="title d-block mb-2"><a href="product.php">Aliquam Quaerat Voluptatem</a></span>
			...
			<div class="productOfferSec container overflow-hidden py-xl-12 py-lg-10 py-md-8 py-5">
				<div class="row">
					<div class="col-12 col-sm-6 mb-sm-0 mb-2">
						<a href="shop.php" class="w-100"><img src="https://via.placeholder.com/570x350" alt="image description" class="img-fluid"></a>
					</div>
						...
						<div class="partnerSlider d-flex flex-wrap">
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="https://via.placeholder.com/105x59" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
			...
			<div class="container-fluid px-xl-20 px-lg-14">
				<!-- subscribeSecBlock -->
				<section class="subscribeSecBlock bgCover col-12 pt-xl-24 pb-xl-12 pt-lg-20 pt-md-16 pt-10 pb-md-8 pb-5" style="background-image: url(https://via.placeholder.com/1720x465)">
