		...
		<main>
				...
				<div class="row">
					<div class="col-12">
						<ul class="list-unstyled contactListHolder mb-0 d-flex flex-wrap text-center">
							...
							<li class="mb-lg-0 col-4">
								<span class="icon d-block mx-auto bg-lightGray py-4 mb-4"><i class="fas fa-envelope"></i></span>
			...
			<div class="mapHolder">
                <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2007.9651398149012!2d30.627023216368574!3d59.78326758181999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x469627fa500abbc7%3A0x7ceacf6643ac84ab!2z0YPQuy4g0JDQu9C10LrRgdCw0L3QtNGA0LAg0KLQvtCy0L_QtdC60L4sIDgsINCh0LDQvdC60YIt0J_QtdGC0LXRgNCx0YPRgNCzLCAxOTY2NDM!5e0!3m2!1sru!2sru!4v1669741542949!5m2!1sru!2sru"
                        width="100%"
                        height="600"
                        style="border:0;"
                        allowfullscreen=""
					...
					<div class="col-12">
						<form action="/contact" method="post" class="contactForm">
							<div class="d-flex flex-wrap row1 mb-md-1">
								<div class="form-group coll mb-5 p-2">
								...
								<div class="form-group coll mb-5 p-2">
									<input type="text" class="form-control" name="tel" placeholder="Telephone number  *">
								</div>
							</div>
							<div class="form-group w-100 mb-6 p-2">
								<textarea class="form-control " name="text" placeholder="Meesage  *" style="height: 232px;"></textarea>
							</div>
							<div class="text-center p-2">
								<button type="submit" class="btn btnTheme btnShop md-round fwEbold text-black py-3 px-4 py-md-3 px-md-4">Send Message</button>
							</div>
						</form>
					</div>
				</div>
